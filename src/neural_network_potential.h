/*
  neural_network_potential.h: This file is part of Free Molecular Dynamics
...
public:
  ...
  SymmetryFunctionsScaler &getScalerForElement(const std::string &element);
  ...
  void calculateTotalEnergy(AtomicStructure &structure);
  ...
  std::vector<SymmetryFunctionsScaler> scalers;
