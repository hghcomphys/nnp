/*
  symmetry_function.cpp: This file is part of Free Molecular Dynamics
...
void G0::gradient_ii(double rij, double drij[3])
{
    ...
    // gradient of symmetry function of atom i respect to itself
...
void G0::gradient_ij(double rij, double drij[3])
{
    ...
    // gradient of symmetry function of atom i respect to other atom j
...
{
    if (rij > cutoffRadius || rik > cutoffRadius)
        return 0;
